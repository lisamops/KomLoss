...
```{r descReadControlTable, dev.args = list(bg = 'white'), include=TRUE, results='asis'}
...
```{r descReadPBTable, dev.args = list(bg = 'white'), include=TRUE, results='asis'}
...
```{r descReadAnimegaTable, dev.args = list(bg = 'white'), include=TRUE, results='asis'}
...
```{r descReadCombiTable, dev.args = list(bg = 'white'), include=TRUE, results='asis'}
