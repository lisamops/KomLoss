...
There was not a significant interaction between days and the intervention on phonic-based training on reading comprehension (`r apa_print(DLS_poisson_3)$full_result$days_contrast_1vs2`). 

### Hypothesis 2: A comprehension-based reading strategy improves reading comprehension.

There was no significant interaction between days and intervention for the comprehension-based reading strategy on reading comprehension (`r apa_print(DLS_poisson_3)$full_result$days_contrast_1vs3`). 

### Hypothesis 3: The combination of both reading strategies is more effective than either strategy on its own.

There was a not significant interaction between the combined group and the other two intervention groups, (`r apa_print(DLS_poisson_3)$full_result$days_contrast_4vs23`).
