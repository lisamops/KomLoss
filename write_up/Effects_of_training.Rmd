...
tab_model(model_PA_3, model_PA_4)
```
...
There was not a significant interaction between time and the intervention on phonemic reading (`r apa_print(DLS_poisson_3)$full_result$scaledays_center___FALSE_contrast_1vs2`). 
...
There was no significant interaction between the combined group and the other two intervention groups 
 (est =`r  summary(DLS_poisson_4)[10]$coefficients[4,][1] `, SE =`r  summary(DLS_poisson_4)[10]$coefficients[4,][2] `, *z* =`r  summary(DLS_poisson_4)[10]$coefficients[4,][3] `, *p*`r  p_small(summary(DLS_poisson_4)[10]$coefficients[4,][4]) `), the combined training did not improve sentence reading over time more than the other two intervention groups.
...
tab_model(model_letter_3, model_letter_4)
```
...
There was not a significant interaction between the combined group and the other two intervention groups  (est =`r  summary(model_letter_4)[10]$coefficients[4,][1] `, SE =`r  summary(model_letter_4)[10]$coefficients[4,][2] `, df =`r  summary(model_letter_4)[10]$coefficients[4,][3] `, *t* =`r  summary(model_letter_4)[10]$coefficients[4,][4] `, *p*`r  p_small(summary(model_letter_4)[10]$coefficients[4,][5]) `), the combined training did not improve letter-sound recognition over time more than the other two intervention groups.
...
There was a significant interaction between the ALL group and the other two intervention groups  (est =`r  summary(model_letter_4)[10]$coefficients[4,][1] `, SE =`r  summary(model_letter_4)[10]$coefficients[4,][2] `, df =`r  summary(model_letter_4)[10]$coefficients[4,][3] `, *t* =`r  summary(model_letter_4)[10]$coefficients[4,][4] `, *p*`r  p_small(summary(model_letter_4)[10]$coefficients[4,][5]) `), the ALL training improved letter-sound recognition over time more than the other two intervention groups.
