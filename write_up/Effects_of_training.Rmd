...
Mean age: 
*m* =`r mean(mlm_data$years_old) `; 
*sd* =`r sd(mlm_data$years_old) `) 
*range* = `r range(mlm_data$years_old) `)   

Training time:
mean

*m* =`r mean((mlm_data %>% filter(time == 1)%>% filter(group != "Control"))$tot_train_time, na.rm = TRUE) `; 
*sd* =`r sd((mlm_data %>% filter(time == 1)%>% filter(group != "Control"))$tot_train_time, na.rm = TRUE) `;
*range* = `r range((mlm_data %>% filter(time == 1)%>% filter(group != "Control"))$tot_train_time, na.rm = TRUE) `
