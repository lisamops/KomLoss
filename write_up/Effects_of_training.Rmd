...
There was not a significant interaction between time and the intervention on phonemic training on sentence reading (`r apa_print(DLS_poisson_4)$full_result$scaledays_center___FALSE_contrast_1vs2`). 

### Hypothesis 1b: Training comprehension-based reading strategies improves sentence awareness. 
There was no significant interaction between time and intervention for the comprehension-based reading strategy on sentence reading (`r apa_print(DLS_poisson_4)$full_result$scaledays_center___FALSE_contrast_1vs3`). 

### Hypothesis 3: The combined training is more effective than either intervention on its own.

There was a not significant interaction between the combined group and the other two intervention groups, (`r apa_print(DLS_poisson_4)$full_result$scaledays_center___FALSE_contrast_4vs23`).
