...
### Hypothesis 1: A phonics-based reading strategy improves phonological awareness.

There was almost a significant interaction between days and the intervention on phonics-based reading, the group training phonic-based strategies improved more than the comparison group (`r apa_print(model_PA_3)$full_result$days_contrast_1vs2`). 

### Hypothesis 2: A comprehension-based reading strategy improves phonological awareness.
...
### Hypothesis 3:  The combination of both reading strategies is more effective than either strategy on its own.
...
### Hypothesis 1:  A phonics-based reading strategy improves word recognition.
...
### Hypothesis 2:  A comprehension-based reading strategy improves word recognition.
...
### Hypothesis 2: A comprehension-based reading strategy improves reading comprehension.
