...
KW_test <- c(kruskal.test(years_old~group, data = mlm_data %>% filter(time == 1))$p.value, #variances not equal
            ...
            kruskal.test(IQ~PPC, data = mlm_data %>% filter(time == 1))$p.value #variances equal
           )
