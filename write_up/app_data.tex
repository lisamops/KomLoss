...
We used R (Version 4.1.2; R Core Team, 2021) and the R-packages \emph{dplyr} (Version 1.0.7; Wickham, François, Henry, \& Müller, 2021), \emph{emmeans} (Version 1.7.0; Lenth, 2021), \emph{FSA} (Version 0.9.1; Ogle, Doll, Wheeler, \& Dinno, 2021), \emph{ggplot2} (Version 3.3.5; Wickham, 2016), \emph{ggpubr} (Version 0.4.0; Kassambara, 2020), \emph{lme4} (Version 1.1.27.1; Bates, Mächler, Bolker, \& Walker, 2015), \emph{lmerTest} (Version 3.1.3; Kuznetsova, Brockhoff, \& Christensen, 2017), \emph{Matrix} (Version 1.3.4; Bates \& Maechler, 2021), \emph{papaja} (Version 0.1.0.9997; Aust \& Barth, 2020), \emph{rio} (Version 0.5.27; Chan, Chan, Leeper, \& Becker, 2021), \emph{sjPlot} (Version 2.8.9; Lüdecke, 2021a), \emph{sjstats} (Version 0.18.1; Lüdecke, 2021b), \emph{tidyr} (Version 1.1.4; Wickham, 2021), and \emph{tinylabels} (Version 0.2.1; Barth, 2021) for all our analyses.
...
Lüdecke, D. (2021a). \emph{sjPlot: Data visualization for statistics in social science}. Retrieved from \url{https://CRAN.R-project.org/package=sjPlot}

\leavevmode\vadjust pre{\hypertarget{ref-R-sjstats}{}}%
Lüdecke, D. (2021b). \emph{Sjstats: Statistical functions for regression models (version 0.18.1)}. \url{https://doi.org/10.5281/zenodo.1284472}

\leavevmode\vadjust pre{\hypertarget{ref-R-FSA}{}}%
Ogle, D. H., Doll, J. C., Wheeler, P., \& Dinno, A. (2021). \emph{FSA: Fisheries stock analysis}. Retrieved from \url{https://github.com/droglenc/FSA}
